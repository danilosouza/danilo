...
% ------------- Item d-------------- %
% plot(y_continuo_sem_perturbacao);hold;plot(y_continuo_com_perturbacao_direta_baixa,'b');
...
% figure;
% plot(y_continuo_sem_perturbacao);hold;plot(y_continuo_com_perturbacao_direta_alta,'b');
...
title('Y afetado duas perturbações simultâneas não-correlacionadas com variância = exp(-6)');