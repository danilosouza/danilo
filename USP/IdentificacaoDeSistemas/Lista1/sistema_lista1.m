...
% legend('Resposta impulsiva com baixa perturbação (N = 1000)','Resposta impulsiva do item "g" com baixa perturbação  ')
% figure;
% plot(t,ir_alta,'k',t,y_pulso_alta,'k:');grid minor; 
% legend('Resposta impulsiva com alta perturbação (N = 1000)','Resposta impulsiva do item "g" com alta perturbação  ')
