...
% legend('Processo sem perturbação', 'Modelo estimando com baixa perturbação', 'Modelo estimando com alta perturbação'); grid minor

% %------------- Item g-------------- %
% sim('lista1_questao7')
% t = 0:length(pulso_entrada)-1;
% plot(t,y_pulso,'k',t,y_pulso_baixa,'k:',t,y_pulso_alta,'k--');
% legend('Resposta ao impulso do processo livre de perturbação','Resposta ao impulso do processo com baixa perturbação','Resposta ao impulso do processo com alta perturbação'); grid minor;
...
% legend('Resposta ao degrau com baixa perturbação','Resposta ao degrau com altaperturbação');
% figure;
...
legend('Convolução com o pulso sem perturbação','Convolução com o pulso de baixa perturbação','Convolução com o pulso de alta perturbação');
figure;
plot(t,y_degrau,'k',t_conv,y_conv,'k:'); grid minor;
legend('Resposta ao degrau do processo sem eprturbação', 'Resposta da convolução do degram com a resposta ao pulso sem perturbação')