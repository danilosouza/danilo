...
\title{Software Freedom Day \\ Virtualização, por que utilizar?}
	...
	\subsection{Histórico}
		\begin{frame}{Histórico}
			\begin{itemize}
				...
				\item Multi-programação em tempo compartilhado
				\item \alert{1960} IBM M44/44X
				\item \alert{1998} Fundação da VMWare			
				\item \alert{2003} Xen
			\end{itemize}
			\begin{multicols}{2}
				\begin{figure}[htb]
	...
	\subsection{XEN}
		\begin{frame}{Histórico}
			\begin{itemize}
				...
				\item \alert{2003} Apresentado ao Público
				\item \alert{2004} Multiprocessamento e \textit{live migration}			
				\item \alert{2006} Xen 3.0 - Virtualização total
