...
\node [block3, right of=init] (posicao) {Construir a matriz posição com os pixels marcados};
...
\path [line]	(posicao) -- (fdps) node [midway, above, sloped] (TextNode) {\color{red}{Posição}} ;
