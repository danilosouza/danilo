...
\title[Redução de tempo]{%
Redução do tempo de execução em técnica de
segmentação de imagens, por re-amostragem dos
...
\begin{frame}{Segmentação de Imagens - Definição}
	...
	\begin{variableblock}{Definição (Gonzáles et. al)}{bg=blue!15,fg=black}{bg=blue!70,fg=white}
...
\begin{frame}{Conclusão}
	...
	\begin{variableblock}{Avaliações futuras}{bg=blue!15,fg=black}{bg=blue!70,fg=white}
  		É necessária uma análise com mais imagens (qualitativo e quantitativo) e também o impacto da quantidade de \textit{pixels} nas marcações.
	\end{variableblock}	
