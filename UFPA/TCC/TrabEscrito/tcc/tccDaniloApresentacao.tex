...
\begin{frame}{Segmentação de Imagens - Aplicações e técnicas}

	\begin{itemize}
		\item Aplicações
		\begin{itemize}
			\item Facilitar classificação de imagens
			\item Edição de imagens
		\end{itemize}
		\item Técnicas
			\begin{itemize}
				...
				\item Dividir e mesclar
					\begin{enumerate}
						...
						\item Verifica se as regiões obedecem o critério
						\item Mescla as regiões em comum
						\item Repete os passo (1) e (2) para regiões diferentes
						\item \textcolor{red}{Não funciona bem para regiões não-uniformes}		
					\end{enumerate}
...
\begin{frame}{O algoritmo}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[scale=0.25]{./figuras/capitulo_4/DiagramaCodigo.pdf}
